...
<?= $this->section('content') ?>
    ...
    <section class="hero-section">
        <div class="banner-slider banner-sec owl-carousel">
            <div class="slider-img">
                <img src="<?php echo base_url(); ?>assets/img/banner/banner-01.jpg" alt="Img">
            </div>
            <div class="slider-img">
                <img src="<?php echo base_url(); ?>assets/img/banner/banner-02.jpg" alt="Img">
            </div>
            <div class="slider-img">
                <img src="<?php echo base_url(); ?>assets/img/banner/banner-03.jpg" alt="Img">
            </div>
            <div class="slider-img">
                <img src="<?php echo base_url(); ?>assets/img/banner/banner-04.jpg" alt="Img">
            </div>
        </div>
        <div class="container">
                                ...
                                <div>
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="flight">
                                            <form action="<?php echo base_url(); ?>flight-grid">
                                        ...
                                        <div class="tab-pane fade" id="Hotels">                                            
                                            <form action="<?php echo base_url(); ?>hotel-grid">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                                        ...
                                        <div class="tab-pane fade" id="Cars">                                          
                                            <form action="<?php echo base_url(); ?>car-grid">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                                                    <div class="d-flex align-items-center flex-wrap">
                                                        <div class="form-check d-flex align-items-center me-3 mb-2">
                                        ...
                                        <div class="tab-pane fade" id="Cruise">                                          
                                            <form action="<?php echo base_url(); ?>cruise-grid">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                                        ...
                                        <div class="tab-pane fade" id="Tour">                                          
                                            <form action="<?php echo base_url(); ?>tour-grid">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
        ...
        <div class="container">
            ...
            <div class="owl-carousel destination-slider nav-center">
                ...
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="<?php echo base_url(); ?>assets/img/destination/destination-01.jpg" alt="img">
                    ...
                    <a href="<?php echo base_url(); ?>destination" class="overlay-circle-link"><i class="isax isax-arrow-right-1"></i></a>
                </div>
                <!-- /Destination Item-->

                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="<?php echo base_url(); ?>assets/img/destination/destination-02.jpg" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                ...
                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="<?php echo base_url(); ?>assets/img/destination/destination-03.jpg" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                ...
                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="<?php echo base_url(); ?>assets/img/destination/destination-04.jpg" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                ...
                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="<?php echo base_url(); ?>assets/img/destination/destination-05.jpg" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="<?php echo base_url(); ?>destination" class="btn btn-dark d-inline-flex align-items-center">View All Locations<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
    </section>
    <!-- /Destination Section -->
    ...
    <section class="section place-section bg-white">
        <div class="container">
            ...
            <div class="tab-content">
                    ...
                    <div class="owl-carousel place-slider nav-center">
                        ...
                        <div class="place-item mb-4">
                                ...
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>hotel-details">
                                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-01.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>hotel-details">
                                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-02.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>hotel-details">
                                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-03.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1"><a href="<?php echo base_url(); ?>hotel-details">Hotel Plaza Athenee</a></h5>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="<?php echo base_url(); ?>assets/img/users/user-01.jpg" class="rounded-circle" alt="img">
										</span>
                        ...
                        <div class="place-item mb-4">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1"><a href="<?php echo base_url(); ?>hotel-details">A Luxury Hotel</a></h5>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="<?php echo base_url(); ?>assets/img/users/user-06.jpg" class="rounded-circle" alt="img">
										</span>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>hotel-details">
                                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-04.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>hotel-details">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1"><a href="<?php echo base_url(); ?>hotel-details">The Start Hotel, Casino</a></h5>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="<?php echo base_url(); ?>assets/img/users/user-02.jpg" class="rounded-circle" alt="img">
										</span>
                        ...
                        <div class="place-item mb-4">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1"><a href="<?php echo base_url(); ?>hotel-details">K’s House Tokyo Oasis</a></h5>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="<?php echo base_url(); ?>assets/img/users/user-04.jpg" class="rounded-circle" alt="img">
										</span>
                ...
                <div class="tab-pane fade" id="flight-list">
                    <div class="owl-carousel place-slider nav-center">
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <a href="<?php echo base_url(); ?>flight-details">
                                    <img src="<?php echo base_url(); ?>assets/img/flight/flight-01.jpg" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="text-truncate mb-1"><a href="<?php echo base_url(); ?>flight-details">AstraFlight 215</a></h5>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="avatar avatar-sm me-2">
										<img src="<?php echo base_url(); ?>assets/img/icons/airindia.svg" class="rounded-circle" alt="icon">
									</span>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="<?php echo base_url(); ?>assets/img/users/user-11.jpg" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>flight-details">
                                            <img src="<?php echo base_url(); ?>assets/img/flight/flight-02.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>flight-details">
                                            <img src="<?php echo base_url(); ?>assets/img/flight/flight-06.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>flight-details">
                                            <img src="<?php echo base_url(); ?>assets/img/flight/flight-07.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="text-truncate mb-1"><a href="<?php echo base_url(); ?>flight-details">Cloudrider 789</a></h5>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="avatar avatar-sm me-2">
										<img src="<?php echo base_url(); ?>assets/img/icons/airindia.svg" class="rounded-circle" alt="icon">
									</span>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="<?php echo base_url(); ?>assets/img/users/user-12.jpg" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <a href="<?php echo base_url(); ?>flight-details">
                                    <img src="<?php echo base_url(); ?>assets/img/flight/flight-03.jpg" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="fav-icon me-2">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="text-truncate mb-1"><a href="<?php echo base_url(); ?>flight-details">Aether Express 901</a></h5>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="avatar avatar-sm me-2">
										<img src="<?php echo base_url(); ?>assets/img/icons/airindia.svg" class="rounded-circle" alt="icon">
									</span>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="<?php echo base_url(); ?>assets/img/users/user-13.jpg" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>flight-details">
                                            <img src="<?php echo base_url(); ?>assets/img/flight/flight-04.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>flight-details">
                                            <img src="<?php echo base_url(); ?>assets/img/flight/flight-08.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>flight-details">
                                            <img src="<?php echo base_url(); ?>assets/img/flight/flight-10.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="text-truncate mb-1"><a href="<?php echo base_url(); ?>flight-details">Silverwing 505</a></h5>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="avatar avatar-sm me-2">
										<img src="<?php echo base_url(); ?>assets/img/icons/airindia.svg" class="rounded-circle" alt="icon">
									</span>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="<?php echo base_url(); ?>assets/img/users/user-15.jpg" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="text-truncate mb-1"><a href="<?php echo base_url(); ?>flight-details">Nimbus 345</a></h5>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="avatar avatar-sm me-2">
										<img src="<?php echo base_url(); ?>assets/img/icons/airindia.svg" class="rounded-circle" alt="icon">
									</span>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="<?php echo base_url(); ?>assets/img/users/user-10.jpg" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="owl-carousel place-slider nav-center">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-06.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-07.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-08.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                <a href="javascript:void(0);" class="avatar avatar-md ms-3 car-avatar-image">
                                    <img src="<?php echo base_url(); ?>assets/img/users/user-08.jpg" class="rounded-circle" alt="img">
                                </a>
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>car-details">Toyota Camry SE 400</a></h5>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-09.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                <a href="javascript:void(0);" class="avatar avatar-md ms-3 car-avatar-image">
                                    <img src="<?php echo base_url(); ?>assets/img/users/user-09.jpg" class="rounded-circle" alt="img">
                                </a>
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <span class="badge badge-secondary  fs-10 fw-medium me-1">Sedan</span>
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>car-details">Ford Mustang 4.0 AT</a></h5>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-10.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>car-details">Ferrari 458 MM Special</a></h5>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-11.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-12.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>car-details">BMW 3.0 Gran Turismo</a></h5>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>car-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cars/car-13.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>car-details">Infiniti QX60 </a></h5>
                    ...
                    <div class="owl-carousel place-slider nav-center">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>cruise-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-05.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>cruise-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-02.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>cruise-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-04.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>cruise-details">Super Aquamarine</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Ciutat Vella, Barcelona</p>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <a href="<?php echo base_url(); ?>cruise-details">
                                    <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-12.jpg" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <a href="javascript:void(0);" class="fav-icon">
                                        <i class="isax isax-heart5"></i>
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>cruise-details">Bonnie Yacht</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Oxford Street, London</p>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <a href="<?php echo base_url(); ?>cruise-details">
                                    <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-09.jpg" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <a href="javascript:void(0);" class="fav-icon">
                                        <i class="isax isax-heart5"></i>
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>cruise-details">Coral Cruiser</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Princes Street, Edinburgh</p>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        <p class="mb-1"><i class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span class="text-dark fw-medium">2021</span></p>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <a href="<?php echo base_url(); ?>cruise-details">
                                    <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-10.jpg" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <a href="javascript:void(0);" class="fav-icon">
                                        <i class="isax isax-heart5"></i>
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>cruise-details">Harbor Haven</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Princes Street, Edinburgh</p>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>cruise-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-01.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>cruise-details">
                                            <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-07.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>cruise-details">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>cruise-details">Albert Yacht</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>King’s Road, Chelsea</p>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                    ...
                    <div class="owl-carousel place-slider nav-center">
                        ...
                        <div class="place-item mb-4 flex-fill">
                                ...
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>tour-details">
                                            <img src="<?php echo base_url(); ?>assets/img/tours/tours-07.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>tour-details">
                                            <img src="<?php echo base_url(); ?>assets/img/tours/tours-08.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>tour-details">
                                            <img src="<?php echo base_url(); ?>assets/img/tours/tours-09.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>tour-details">Rainbow Mountain Valley</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Ciutat Vella, Barcelona</p>
                                <div class="mb-3">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>tour-details">
                                            <img src="<?php echo base_url(); ?>assets/img/tours/tours-10.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>tour-details">Mystic Falls</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Oxford Street, London</p>
                                <div class="mb-3">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>tour-details">
                                            <img src="<?php echo base_url(); ?>assets/img/tours/tours-11.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>tour-details">Crystal Lake</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Princes Street, Edinburgh</p>
                                <div class="mb-3">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>tour-details">
                                            <img src="<?php echo base_url(); ?>assets/img/tours/tours-12.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>tour-details">Majestic Peaks</a></h5>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="<?php echo base_url(); ?>tour-details">
                                            <img src="<?php echo base_url(); ?>assets/img/tours/tours-13.jpg" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <h5 class="mb-1 text-truncate"><a href="<?php echo base_url(); ?>tour-details">Enchanted Forest</a></h5>
                                <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>King’s Road, Chelsea</p>
                                <div class="mb-3">
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="<?php echo base_url(); ?>hotel-grid" class="btn btn-dark d-inline-flex align-items-center">View All Places<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
    </section>
    <!-- /Place Section -->
    ...
    <section class="section about-section">
        <div class="container">
                    ...
                    <div class="about-image mb-4 mb-lg-0">
                        <div class="about-listing">
                            ...
                            <div class="listing-img">
                                <div>
                                    <img src="<?php echo base_url(); ?>assets/img/icons/listing.svg" alt="icon">
                                </div>
                                <a href="<?php echo base_url(); ?>add-hotel" class="btn btn-warning text-gray-9">Add You Listings</a>
                            </div>
                        </div>
                        <div class="about-img">
                            <img src="<?php echo base_url(); ?>assets/img/about.png" alt="about">
                        </div>
                        <div class="about-progress d-inline-flex align-items-center">
                            <img src="<?php echo base_url(); ?>assets/img/icons/progress-icon.svg" alt="icon">
                            <div class="ms-2">
                                <p class="fs-10 mb-1">Today’s Earnings</p>
                                <h6 class="fs-13">$2500</h6>
                            </div>
                            <a href="<?php echo base_url(); ?>wallet" class="btn btn-teal btn-sm fw-normal ms-4">Withdraw</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="d-flex align-items-center flex-wrap about-btn gap-2">
                        <a href="<?php echo base_url(); ?>about-us" class="btn btn-white d-flex align-items-center">Learn More<i class="isax isax-arrow-circle-right ms-2"></i></a>
                        <div class="avatar-list-stacked avatar-group-md me-2">
                            <span class="avatar avatar-rounded">
								<img class="border border-white" src="<?php echo base_url(); ?>assets/img/users/user-01.jpg" alt="img">
							</span>
                            <span class="avatar avatar-rounded">
								<img class="border border-white" src="<?php echo base_url(); ?>assets/img/users/user-04.jpg" alt="img">
							</span>
                            <span class="avatar avatar-rounded">
								<img src="<?php echo base_url(); ?>assets/img/users/user-05.jpg" alt="img">
							</span>
                            <span class="avatar avatar-rounded">
								<img src="<?php echo base_url(); ?>assets/img/users/user-06.jpg" alt="img">
							</span>
                        </div>
                        <div>
                            <div class="d-flex align-items-center">
            ...
            <div class="about-bg">
                <img src="<?php echo base_url(); ?>assets/img/bg/about-bg.png" alt="img" class="about-bg-01">
                <img src="<?php echo base_url(); ?>assets/img/bg/about-bg-01.svg" alt="img" class="about-bg-02">
            </div>
        </div>
    </section>
    <!-- /About Section -->
        ...
        <div class="container">
            ...
            <div class="owl-carousel experts-slider nav-center">
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-purple-100 position-relative">
                            <img src="<?php echo base_url(); ?>assets/img/expert/expert-01.png" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/img/flags/brazil.svg" alt="img" class="me-2">Brazil, Rio</p>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-orange-100 position-relative">
                            <img src="<?php echo base_url(); ?>assets/img/expert/expert-02.png" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/img/flags/japan.svg" alt="img" class="me-2">Tokyo, Japan</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>21</h6>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-pink-100 position-relative">
                            <img src="<?php echo base_url(); ?>assets/img/expert/expert-03.png" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/img/flags/africa.svg" alt="img" class="me-2">Cape Town, South Africa</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>15</h6>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-teal-100 position-relative">
                            <img src="<?php echo base_url(); ?>assets/img/expert/expert-04.png" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <h5 class="mb-1"><a href="javascript:void(0);">Damien Martien</a></h5>
                        <p class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/img/flags/australia.svg" alt="img" class="me-2">Sydney, Australia</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>15</h6>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-purple-100 position-relative">
                            <img src="<?php echo base_url(); ?>assets/img/expert/expert-05.png" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/img/flags/norway.svg" alt="img" class="me-2">Oslo, Norway</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>17</h6>
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="<?php echo base_url(); ?>team" class="btn btn-dark">View All Experts<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
    </section>
    <!-- /Experts Section -->
        ...
        <div class="container">
            ...
            <div class="owl-carousel client-slider">
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-01.svg" alt="img">
                </div>
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-02.svg" alt="img">
                </div>
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-03.svg" alt="img">
                </div>
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-04.svg" alt="img">
                </div>
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-05.svg" alt="img">
                </div>
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-06.svg" alt="img">
                </div>
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-07.svg" alt="img">
                </div>
                <div class="client-img">
                    <img src="<?php echo base_url(); ?>assets/img/clients/client-04.svg" alt="img">
                </div>
    ...
    <section class="section testimonial-section">
                ...
                <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        ...
                        <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-md  flex-shrink-0">
                                    <img src="<?php echo base_url(); ?>assets/img/users/user-03.jpg" class="rounded-circle" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <span class="avatar avatar-md  flex-shrink-0">
                                    <img src="<?php echo base_url(); ?>assets/img/users/user-05.jpg" class="rounded-circle" alt="img">
                                </span>
                                <div class="ms-2">
        ...
        <div class="testimonial-bg">
            <img src="<?php echo base_url(); ?>assets/img/bg/testimonial-bg-01.svg" alt="img">
        </div>
    </section>
    <!-- /Testimonial Section -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="update-sec">
                        ...
                        <div class="update-bg">
                            <img src="<?php echo base_url(); ?>assets/img/bg/update-bg.png" alt="img">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section blog-section pt-0">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="<?php echo base_url(); ?>blog-details" class="blog-img">
                            <img src="<?php echo base_url(); ?>assets/img/blog/blog-01.jpg" alt="img">
                        </a>
                        ...
                        <div class="blog-info text-center">
                                ...
                                <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-sm flex-shrink-0 me-2">
											<img src="<?php echo base_url(); ?>assets/img/users/user-01.jpg" class="rounded-circle border border-white" alt="img">
										</span>
                                        <p>Bryan Bradfield</p>
                                    </a>
                                </div>
                            ...
                            <h5><a href="<?php echo base_url(); ?>blog-details">Top 10 Hidden Gems places in Central Europe in 2025</a></h5>
                        </div>
                    </div>
                </div>
                <!-- /Blog Item-->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="<?php echo base_url(); ?>blog-details" class="blog-img">
                            <img src="<?php echo base_url(); ?>assets/img/blog/blog-02.jpg" alt="img">
                        </a>
                        ...
                        <div class="blog-info text-center">
                            <div class="d-inline-flex align-items-center justify-content-center">
                                <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-sm flex-shrink-0 me-2">
											<img src="<?php echo base_url(); ?>assets/img/users/user-02.jpg" class="rounded-circle border border-white" alt="img">
										</span>
                                        <p>Michell West</p>
                                    </a>
                                </div>
                            ...
                            <h5><a href="<?php echo base_url(); ?>blog-details">Exploring the World: Your Ultimate Dream Tour Itinerary</a></h5>
                        </div>
                    </div>
                </div>
                <!-- /Blog Item-->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="<?php echo base_url(); ?>blog-details" class="blog-img">
                            <img src="<?php echo base_url(); ?>assets/img/blog/blog-03.jpg" alt="img">
                        </a>
                        ...
                        <div class="blog-info text-center">
                            <div class="d-inline-flex align-items-center justify-content-center">
                                <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-sm flex-shrink-0 me-2">
											<img src="<?php echo base_url(); ?>assets/img/users/user-03.jpg" class="rounded-circle border border-white" alt="img">
										</span>
                                        <p>Patricia Hasbro</p>
                                    </a>
                                </div>
                            ...
                            <h5><a href="<?php echo base_url(); ?>blog-details">New York City, USA - The City That  Never Sleeps</a></h5>
                        </div>
                    </div>
                </div>
                <!-- /Blog Item-->
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="<?php echo base_url(); ?>blog-grid" class="btn btn-dark d-inline-flex align-items-center">View All Articles<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
    </section>
    <!-- /Blog Section -->
