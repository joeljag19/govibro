            ...
            <div class="col-md-12 col-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0">
                        <li class="breadcrumb-item"><a href="<?= base_url('/') ?>"><i class="isax isax-home5"></i></a></li>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body p-0">
                        <form id="filterForm" onsubmit="return false;">
                            ...
                            <div class="accordion accordion-list">
                                ...
                                <div class="accordion-item border-bottom p-3">
                                    <h2 class="accordion-header"><div class="accordion-button p-0" data-bs-toggle="collapse" data-bs-target="#accordion-categories"><i class="isax isax-buildings me-2 text-primary"></i>Tipo de Tour</div></h2>
            ...
            <div class="col-xl-9 col-lg-8 theiaStickySidebar">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="list-item d-flex align-items-center mb-3">
                            <!-- Switcher de Vistas -->
                            <a href="#" class="list-icon me-2 view-switcher active" data-view="grid" title="Vista de Cuadrícula"><i class="isax isax-grid-1"></i></a>
                            <a href="#" class="list-icon me-2 view-switcher" data-view="list" title="Vista de Lista"><i class="isax isax-firstline"></i></a>
                            <a href="#" class="list-icon view-switcher" data-view="map" title="Vista de Mapa"><i class="isax isax-map-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <!-- Contenedor para Grid y List -->
                <div id="resultsContainer">
                    <div class="row justify-content-center" id="toursContainer"></div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD6adZVdzTvBpE2yBRK8cDfsss8QXChK0I&callback=initMap" async defer></script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#priceRangeDisplay").text("$0 - $10000");
