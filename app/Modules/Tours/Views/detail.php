                    ...
                    <div class="service-wrap mb-4">
                        <div class="slider-wrap vertical-slider tour-vertical-slide d-flex align-items-center">
                            ...
                            <div class="slider-for nav-center" id="large-img">
                                <?php
                                // Preparamos un array con todas las imágenes en el orden correcto
                                $all_images = [];
                                ...
                                <?php if (!empty($all_images)): ?>
                                    <?php foreach ($all_images as $image): ?>
                                        <div class="service-img">
                                            <a href="<?= base_url('uploads/' . $image) ?>" data-fancybox="gallery">
                                                <img src="<?= base_url('uploads/' . $image) ?>" class="img-fluid" alt="Gallery Image">
                                            </a>
                                        </div>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <div class="service-img">
                                        <img src="<?= base_url('assets/img/tours/tour-large-01.jpg') ?>" class="img-fluid" alt="Default Tour Image">
                                    </div>
                                <?php endif; ?>
                            </div>

                            <?php if (!empty($all_images)): ?>
                                <a href="<?= base_url('uploads/' . $all_images[0]) ?>" data-fancybox="gallery" class="btn btn-white btn-xs view-btn"><i class="isax isax-image me-1"></i>See All</a>
                            <?php endif; ?>
                            ...
                            <div class="slider-nav nav-center" id="small-img">
                                <?php if (count($all_images) > 1): ?>
                                    <?php foreach ($all_images as $image): ?>
                                        <div>
                                            <img src="<?= base_url('uploads/' . $image) ?>" class="img-fluid" alt="Slider Thumb">
                                        </div>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
