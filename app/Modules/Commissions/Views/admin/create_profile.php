        ...
        <div class="container-fluid">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Crear Perfil de Comisiones</h4>
                </div>
                <div class="text-end">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('commissions/admin/create-profile') ?>" method="post">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Función para añadir un nuevo rango
    function addRange() {
        const rangeHtml = `
            <div class="row align-items-center mb-3 p-2 border rounded range-item">
                <div class="col-md-3">
                    <label class="form-label">Día Inicio</label>
                    <input type="number" name="ranges[${rangeIndex}][start_day]" class="form-control" placeholder="Ej: 1" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label">Día Fin</label>
                    <input type="number" name="ranges[${rangeIndex}][end_day]" class="form-control" placeholder="Ej: 30 (vacío para infinito)">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Comisión del Reseller (%)</label>
                    <input type="number" name="ranges[${rangeIndex}][reseller_share]" class="form-control" step="0.01" placeholder="Ej: 10" required>
                </div>
    ...
    // Añadir un rango inicial al cargar la página
    addRange();
});
</script>
<?= $this->endSection() ?>