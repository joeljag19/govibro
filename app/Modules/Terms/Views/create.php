...
<div class="content-page">
    <div class="content">
        <div class="container-fluid">
            <h4 class="fs-18 fw-semibold my-3">Crear Nuevo Término</h4>
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('admin/terms/store') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="<?= old('name') ?>" placeholder="Ej: Fácil, Senderismo, Snorkel" required>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="attr_id" name="attr_id" class="form-control" required>
                                ...
                                <?php foreach ($attributes as $attribute): ?>
                                    <option value="<?= esc($attribute['id']) ?>" <?= old('attr_id') == $attribute['id'] ? 'selected' : '' ?>><?= esc($attribute['name']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
