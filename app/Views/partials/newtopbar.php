<?php
// --- Lógica de Control ---
// El controlador ahora nos pasa las opciones de layout.
// Por defecto, usamos la cabecera estándar.
$header_style = $layoutOptions['header_style'] ?? 'default';
$page = $layoutOptions['page'] ?? '';
// El idioma actual lo obtenemos del servicio de request.
$locale = service('request')->getLocale();
?>

 <ul class="main-nav">
                            <li><a href="<?= site_url('/') ?>"><?= lang('Site.menu.home') ?></a></li>
                            <li><a href="<?= site_url('tours') ?>"><?= lang('Site.menu.tours') ?></a></li>
                             <li><a href="<?= site_url('tours') ?>"><?= lang('Site.menu.flights') ?></a></li>
                              <li><a href="<?= site_url('tours') ?>"><?= lang('Site.menu.hotels') ?></a></li>
                               <li><a href="<?= site_url('tours') ?>"><?= lang('Site.menu.cars') ?></a></li>
                            </ul>
