                ...
                <div class="modal-body p-4 pt-0">
                    <form action="<?= base_url('auth/login') ?>" method="post">
                        <div class="text-center mb-3">
                            <h5 class="mb-1"><?= lang('Site.menu.login') ?></h5>
                            <p><?= lang('Site.text.accountSignIn') ?></p>
                        </div>
                        <div class="mb-2">
                            <label class="form-label"><?= lang('Site.text.auth.email') ?></label>
                            <div class="input-icon">
                                <span class="input-icon-addon">
                                    <i class="isax isax-message"></i>
                                </span>
                                <input type="email" name="email" id="email"  class="form-control form-control-lg" placeholder="<?= lang('Site.text.auth.enterEmail') ?>">
                            </div>
                        </div>
                        <div class="mb-2">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="password" name="password" id="password" class="form-control form-control-lg pass-input" placeholder="<?= lang('Site.text.auth.enterPassword') ?>">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                <div class="form-check d-flex align-items-center mb-2">
                                    ...
                                    <label class="form-check-label ms-2 text-gray-9 fs-14" for="remembers_me">
                                       <?= lang('Site.text.auth.rememberMe') ?>
                                    </label>
                                </div>
                                <a href="javascript:void(0);" class="link-primary fw-medium fs-14 mb-2" data-bs-toggle="modal" data-bs-target="#forgot-modal"><?= lang('Site.text.auth.forgotPassword') ?></a>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <a href="javascript:void(0);" class="btn btn-light flex-fill d-flex align-items-center justify-content-center me-2">
                                <img src="<?php echo base_url(); ?>assets/img/icons/google-icon.svg" class="me-2" alt="Img">Google
                            </a>
                            <a href="javascript:void(0);" class="btn btn-light flex-fill d-flex align-items-center justify-content-center">
                                <img src="<?php echo base_url(); ?>assets/img/icons/fb-icon.svg" class="me-2" alt="Img">Facebook
                            </a>
                        </div>
                        <div class="d-flex justify-content-center">
                            <p class="fs-14"><?= lang('Site.text.auth.noAccount') ?> <a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#register-modal">Sign up</a></p>
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-body p-4 pt-0">
                    <form action="<?php echo base_url(); ?>index">
                        <div class="text-center border-bottom mb-3">
                            <h5 class="mb-1"><?= lang('Site.text.signUp') ?></h5>
    ...
    <div class="modal fade" id="add_faq" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>add-flight">    
    ...
    <div class="modal fade" id="add_review">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>flight-details">    
    ...
    <div class="modal fade" id="filter_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>hotel-map">    
                    <div class="modal-body">
                        <div class=" mb-3">
    ...
    <div class="modal fade" id="add_review">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>hotel-details">
                    <div class="modal-body pb-0">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                ...
                <div class="modal-body pb-2">
                    <div class="owl-carousel room-slider nav-center mb-4">
                        <div class="service-img">
                              <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-large-01.jpg" class="img-fluid" alt="Slider Img">
                        </div>
                        <div class="service-img">
                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-large-02.jpg" class="img-fluid" alt="Slider Img">
                        </div>
                        <div class="service-img">
                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-large-03.jpg" class="img-fluid" alt="Slider Img">
                        </div>
                        <div class="service-img">
                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-large-04.jpg" class="img-fluid" alt="Slider Img">
                        </div>
                        <div class="service-img">
                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-large-05.jpg" class="img-fluid" alt="Slider Img">
                        </div>
                        <div class="service-img">
                            <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-large-06.jpg" class="img-fluid" alt="Slider Img">
                        </div>
                    </div>
    ...
    <div class="modal fade" id="add_faq" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>add-hotel">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Question <span class="text-danger"> *</span></label>
                            <input type="text" class="form-control">
    ...
    <div class="modal fade" id="add_review">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>car-details">    
                    <div class="modal-body pb-0">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
...
<?php if($page === 'add-car') { ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url(); ?>add-car">
                <div class="modal-body">
                    <div class="mb-3">
    ...
    <div class="modal fade" id="filter_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>cruise-map">    
                    <div class="modal-body">
                        <div class=" mb-3">
                            <div class="d-flex align-items-center mb-2">
                                <span class="me-2"><i class="isax isax-ranking text-primary"></i></span>
    ...
    <div class="modal fade" id="add_review">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>cruise-details">    
                    <div class="modal-body pb-0">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
    ...
    <div class="modal fade" id="add_iternary" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>add-cruise">    
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Itenary <span class="text-danger"> *</span></label>
                            <input type="text" class="form-control">
    ...
    <div class="modal fade" id="filter_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>tour-map">    
                    <div class="modal-body">
                        <div class=" mb-3">
                            <div class="d-flex align-items-center mb-2">
                                <span class="me-2"><i class="isax isax-ranking text-primary"></i></span>
    ...
    <div class="modal fade" id="add_review">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>tour-details">    
                    <div class="modal-body pb-0">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
    ...
    <div class="modal fade" id="add_faq">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>add-tour">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Question <span class="text-danger"> *</span></label>
                            <input type="text" class="form-control">
...
<?php if($page === 'customer-flight-booking') { ?>
    <!-- Upcoming Modal -->
                ...
                <div class="modal-body">
                    <div class="upcoming-content">
                        <div class="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                            <div class="d-flex align-items-center flex-wrap">
                                <div class="me-2">
                                    <img src="<?php echo base_url(); ?>assets/img/flight/flight-01.jpg" alt="image" class="avatar avartar-md avatar-rounded">
                                </div>
                                <div>
                                    <h6 class="mb-1">AstraFlight 215</h6>
                                    <div class="title-list">
                                        <p class="d-flex align-items-center pe-2 me-2 border-end border-light fw-normal"><img src="<?php echo base_url(); ?>assets/img/icons/airindia.svg" alt="image" class="avatar avatar-sm avatar-rounded me-2">Air India</p>
    ...
    <div class="modal fade" id="completed" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>flight-details" class="btn btn-md btn-primary">Book Again</a>   
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancelled" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>flight-details" class="btn btn-md btn-primary">Reschedule</a>   
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>customer-flight-booking">    
                        <div class="text-center">
                            <div class="mb-4">
    ...
    <div class="modal fade" id="edit_review">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>review">    
                    <div class="modal-body pb-0">                    
                        <div class="mb-3">
                            <label class="form-label">Your Rating <span class="text-danger">*</span></label>
                            <div class="selection-wrap">
    ...
    <div class="modal fade" id="changePassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>security-settings">
                    <div class="modal-body pb-0">
                        <div class="mb-3">
...
<?php if($page === 'agent-dashboard') { ?>
                ...
                <div class="modal-body">
                    <div class="upcoming-content">
                        <div class="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                            <div class="d-flex align-items-center flex-wrap">
                                <div class="me-2">
                                    <img src="<?php echo base_url(); ?>assets/img/hotels/hotel-13.jpg" alt="image" class="avatar avartar-md avatar-rounded">
                                </div>
                                <div>
    ...
    <div class="modal fade" id="completed" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>hotel-details" class="btn btn-md btn-primary">Book Again</a>    
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancelled" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>hotel-details" class="btn btn-md btn-primary">Reschedule</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>agent-dashboard">
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a href="<?php echo base_url(); ?>agent-listings" class="btn btn-primary">Yes</a> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="#" class="btn btn-light me-2">No</a>
                            <a href="<?php echo base_url(); ?>agent-listings" class="btn btn-primary">Yes, Delete</a> 
                        </div>
                    </div>
                </div>
            </div>
...
<?php if($page === 'agent-hotel-booking') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>agent-hotel-booking">    
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
                        ...
                        <div>
                                ...
                                <div class="row justify-content-between align-items-center flex-wrap row-gap-4">
                                    <div class="col-md-6">
                                        <div class="mb-2 invoice-logo-dark">
                                            <img src="<?php echo base_url(); ?>assets/img/logo-dark.svg" class="img-fluid" alt="logo">
                                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <img src="<?php echo base_url(); ?>assets/img/invoice/qr.svg" class="img-fluid" alt="QR">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="border-bottom mb-3 me-2">
                                <div class="row justify-content-end align-items-end text-end">
                                    <div class="col-md-3">
                                        <div class="text-end">
                                            <img src="<?php echo base_url(); ?>assets/img/invoice/sign.svg" class="img-fluid" alt="sign">
                                        </div>
                                        <div class="text-end mb-3">
    ...
    <div class="modal fade" id="edit_card" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-md w-500">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>agent-earnings">    
                    <div class="modal-body">
                        <div class="mb-3">
...
<?php if($page === 'agent-car-booking') { ?>
                ...
                <div class="modal-body">
                    <div class="upcoming-content">
                        <div class="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                            <div class="d-flex align-items-center flex-wrap">
                                <div class="me-2">
                                    <img src="<?php echo base_url(); ?>assets/img/cars/car-16.jpg" alt="image" class="avatar avartar-md avatar-rounded">
                                </div>
                                <div>
    ...
    <div class="modal fade" id="completed" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>car-details" class="btn btn-md btn-primary">Book Again</a>  
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancelled" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>car-details" class="btn btn-md btn-primary">Reschedule</a>  
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>agent-car-booking">    
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
...
<?php if($page === 'agent-cruise-booking') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="upcoming-content">
                        <div class="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                            <div class="d-flex align-items-center flex-wrap">
                                <div class="me-2">
                                    <img src="<?php echo base_url(); ?>assets/img/cruise/cruise-15.jpg" alt="image" class="avatar avartar-md avatar-rounded">
                                </div>
                                <div>
    ...
    <div class="modal fade" id="completed" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>cruise-details" class="btn btn-md btn-primary">Book Again</a>   
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancelled" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>cruise-details" class="btn btn-md btn-primary">Reschedule</a>   
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>agent-cruise-booking">  
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
...
<?php if($page === 'agent-enquiry-details') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
...
<?php if($page === 'agent-flight-booking') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>agent-flight-booking">  
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
...
<?php if($page === 'agent-notifications') { ?>
    <!-- Delete Modal -->
    <div class="modal fade" id="delete_modal">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?php echo base_url(); ?>agent-notifications">  
                        <div class="text-center">
        ...
        <div class="modal-dialog  modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="<?php echo base_url(); ?>agent-plans-settings" class="btn btn-light me-2">Back to Plans</a>
...
<?php if($page === 'agent-plans-settings') { ?>
    <!-- Transaction Details Modal -->
    <div class="modal fade" id="transaction_detail" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-lg invoice-modal">
            <div class="modal-content">
                        ...
                        <div class="col-lg-4 d-flex">
                            <div class="card flex-fill mb-0">
                                <div class="card-header">
                                    ...
                                    <div>
                                        <a href="<?php echo base_url(); ?>agent-plans" class="btn btn-dark d-flex align-items-center justify-content-center ">Choose Plan <i class="ms-2 isax isax-arrow-right-3"></i></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="mb-2">
                        ...
                        <div class="col-lg-4 d-flex">
                            <div class="card flex-fill mb-0 bg-light-400">
                                <div class="card-header">
                                    ...
                                    <div>
                                        <a href="<?php echo base_url(); ?>agent-plans" class="btn btn-primary d-flex align-items-center justify-content-center ">Choose Plan <i class="ms-2 isax isax-arrow-right-3"></i></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="mb-2">
    ...
    <div class="modal fade" id="add_card" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-md w-500">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>agent-plans-settings">  
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Card Holder Name <span class="text-danger"> *</span></label>
                            <div class="input-icon-start position-relative">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="#" class="btn btn-light me-2">No</a>
                            <a href="<?php echo base_url(); ?>agent-plans-settings" class="btn btn-primary">Yes, Delete</a>   
                        </div>
                    </div>
                </div>
            </div>
...
<?php if($page === 'agent-security-settings') { ?>
    <!-- Change password -->
    <div class="modal fade" id="changePassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>agent-security-settings">  
                    <div class="modal-body pb-0">
                        <div class="mb-3">
                            <label class="form-label">Current Password <span class="text-primary">*</span> </label>
                            <div class="input-icon">
...
<?php if($page === 'agent-tour-booking') { ?>
    <!-- Upcoming Modal -->
                ...
                <div class="modal-body">
                    <div class="upcoming-content">
                        <div class="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                            <div class="d-flex align-items-center flex-wrap">
                                <div class="me-2">
                                    <img src="<?php echo base_url(); ?>assets/img/tours/tours-21.jpg" alt="image" class="avatar avartar-md avatar-rounded">
                                </div>
                                <div>
    ...
    <div class="modal fade" id="completed">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>tour-details" class="btn btn-md btn-primary">Book Again</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancelled">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>tour-details" class="btn btn-md btn-primary">Reschedule</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>agent-tour-booking">
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
                ...
                <div class="modal-body">
                    <div>
                        <div class="booking-icon text-center mb-3">
                            <img src="<?php echo base_url(); ?>assets/img/icons/tick-circle.svg" alt="icon" class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center ">
                            <a href="<?php echo base_url(); ?>car-booking-confirmation" class="btn btn-primary d-flex flex-shrink-0">View Booking Details</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php if($page === 'customer-car-booking') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>customer-car-booking">
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
...
<?php if($page === 'customer-cruise-booking') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-xl">
        <div class="modal-content">
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>customer-cruise-booking">  
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
...
<?php if($page === 'customer-hotel-booking') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
    ...
    <div class="modal fade" id="cancel-booking">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <form action="<?php echo base_url(); ?>customer-tour-booking">
                        <div class="text-center">
                            <div class="mb-4">
                                <i class="isax isax-location-cross5 text-danger fs-40"></i>
                            </div>
...
<?php if($page === 'customer-tour-booking') { ?>
    <!-- Upcoming Modal -->
    <div class="modal fade" id="upcoming">
        <div class="modal-dialog  modal-dialog-centered modal-xl">
            <div class="modal-content">
            ...
            <div class="modal-content booking-success-modal">
                <div class="modal-body">
                    <div>
                        ...
                        <div class="d-flex align-items-center justify-content-center ">
                            <a href="<?php echo base_url(); ?>flight-booking-confirmation" class="btn btn-primary d-flex flex-shrink-0">View Booking Details</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content booking-success-modal">
                <div class="modal-body">
                    <div>
                        ...
                        <div class="d-flex align-items-center justify-content-center ">
                            <a href="<?php echo base_url(); ?>booking-confirmation" class="btn btn-primary d-flex flex-shrink-0">View Booking Details</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content booking-success-modal">
                <div class="modal-body">
                    <div>
                        ...
                        <div class="d-flex align-items-center justify-content-center ">
                            <a href="<?php echo base_url(); ?>cruise-booking-confirmation" class="btn btn-primary d-flex flex-shrink-0">View Booking Details</a>
                        </div>
                    </div>
                </div>
...
<?php if($page === 'notification') { ?>
    ...
    <div class="modal fade" id="delete_modal">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?php echo base_url(); ?>notification">
                        <div class="text-center">
                            <h5 class="mb-3">Delete Notification</h5>
                            <p class="mb-3">Are you sure you want to delete this notification?</p>
                            <div class="d-flex align-items-center justify-content-center">
